...
function searchChannel(search) {
	...
	defineScreen("Search: " + search)
	  ...
	  $.ajax({
          url: 'https://api.twitch.tv/kraken/search/streams?client_id=7wm38hmi8gpogctq8pz0slhtg9b8jhq&limit=100&q=' + search,
          type: 'GET',
...
function showGames(){
	...
	defineScreen("All Games")
	 ...
	 $.ajax({
	          url: 'https://api.twitch.tv/kraken/games/top?client_id=7wm38hmi8gpogctq8pz0slhtg9b8jhq&limit=100&offset=0',
	          type: 'GET',
	          contentType: 'application/json',
	          dataType: 'jsonp',
	          success: function(data) {
...
function showChannels(){
	...
	$.ajax({
		url: 'https://api.twitch.tv/kraken/streams?client_id=7wm38hmi8gpogctq8pz0slhtg9b8jhq&limit=100',
		type: 'GET',
		contentType: 'application/json',
		dataType: 'jsonp',
		success: function(data) {
